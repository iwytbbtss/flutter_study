...
class _WebViewXPageState extends State<WebViewXPage> {
  ...
  void initState() {
    ...
    test = 'test';
    initialContent =
        '<h4> This is some hardcoded HTML code embedded inside the webview <h4> <h2> Hello world! <h2><button onclick="testPlatformSpecificMethod($test)">button</button>';
  }
  ...
  Future<void> _callPlatformSpecificJsMethod() async {
    try {
      await webviewController
          .callJsMethod('testPlatformSpecificMethod', ['Hi webviewx']);
    } catch (e) {
      showAlertDialog(
        executeJsErrorMessage,
        context,
